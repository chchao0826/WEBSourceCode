# 获得卡号的详细信息
def GETSchedulingSQL(sWorkingProcedureName):
    ...
    return "SELECT \
        ...
        ORDER BY A.nRowNumber, B.sLocation "%(sWorkingProcedureName, sWorkingProcedureName2)


def GetSchedulingDtlSQL(nHDRID):
    nHDRID1 = ''
    nHDRID2 = ''
    nHDRID3 = ''
    nHDRID4 = ''
